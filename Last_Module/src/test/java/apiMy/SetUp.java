...
public class SetUp {
    ...
    public DummyJsonClientImpl impl = new DummyJsonClientImpl();
//    api.Response<api.User> response = impl.getUser(api.DummyJsonClientImpl.id);
//    api.User user=impl.getDataUser(response);
//    api.Token token=impl.getToken(impl.login(user));
