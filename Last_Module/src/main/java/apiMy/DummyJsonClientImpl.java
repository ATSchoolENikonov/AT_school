...
public class DummyJsonClientImpl implements DummyJsonClient {
    ...
    public Response<apiMy.User> getUser(int id) {
        Response<apiMy.User> trueResponse = new Response<>();
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            trueResponse.setJson(new apiMy.User(result.getLong("id"), result.getString("username"), result.getString("password")));
    ...
    public Response<Token> login(apiMy.User u) {
    ...
    public Response<List<Post>> getPosts(apiMy.User u, Token token) {
    ...
    public User getDataUser(Response<apiMy.User> resp) {
        return new apiMy.User(resp.json.getId(), resp.json.getLogin(), resp.json.getPassword());
    }
